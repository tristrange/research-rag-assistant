...
ANSWER_CASES: list[AnswerEvaluationCase] = [
    ...
    {
        "id": "cited-rosiglitazone",
        "question": "What does the cited Asp et al. 2011 publication report about Rosiglitazone? Distinguish this cited work from the current paper's experiments.",
        "answerable": True,
        "reference_answer": "The cited Asp et al. 2011 publication reports that Rosiglitazone delayed weight loss and anorexia while attenuating adipose depletion in mice with cancer cachexia. This is cited literature, not a treatment experiment conducted in the current paper.",
        "evidence": [{"document": "sample.pdf", "page": 10,
                      "quote": "Rosiglitazone delayed weight loss and anorexia while attenuating adipose depletion in mice with cancer cachexia"}],
    },
    {
        "id": "own-rosiglitazone-dose",
        "question": "What dose of Rosiglitazone did the authors administer in this paper's mouse experiments?",
        "answerable": False,
        "reference_answer": "The current paper does not report administering Rosiglitazone or a dose in its experiments. A bibliography entry about another study is not evidence for such a dose.",
        "evidence": [],
    },
    {
        "id": "cited-ceramide-study",
        "question": "What effect of inhibiting ceramide synthesis is described by the cited Morigny et al. 2026 publication title?",
        "answerable": True,
        "reference_answer": "The cited Morigny et al. 2026 title reports that inhibition of ceramide synthesis ameliorates body wasting in a cancer cachexia model. This is a cited study, not a result of the current paper's experiments.",
        "evidence": [{"document": "sample.pdf", "page": 10,
                      "quote": "Inhibition of ceramide synthesis ameliorates body wasting in a cancer cachexia model"}],
    },
    {
        "id": "own-rosiglitazone-effect",
        "question": "Did the authors find in this paper's experiments that Rosiglitazone delayed weight loss and anorexia while attenuating adipose depletion?",
        "answerable": False,
        "reference_answer": "The supplied paper does not report this as a finding of its own experiments. That claim appears in the title of a cited Asp et al. 2011 study. There is insufficient evidence to assert it as the current authors' experimental result.",
        "evidence": [],
    },
]
